...
public class CustomerB {
    public static void main(String[] args) throws IOException {
        ...
        Socket CustomerB = null;
        PrintWriter out = null;
        BufferedReader in = null;
        int WarehouseSocketNumber = 4545;
        String WarehouseServerName = "localhost";
        String WarehouseClientID = "CustomerB";

        try {
            CustomerB = new Socket(WarehouseServerName, WarehouseSocketNumber);
            out = new PrintWriter(CustomerB.getOutputStream(), true);
            in = new BufferedReader(new InputStreamReader(CustomerB.getInputStream()));
