...
public class CustomerA {
    public static void main(String[] args) throws IOException {
        ...
        Socket CustomerA = null;
        PrintWriter out = null;
        BufferedReader in = null;
        int WarehouseSocketNumber = 4545;
        String WarehouseServerName = "localhost";
        String WarehouseClientID = "CustomerA";

        try {
            CustomerA = new Socket(WarehouseServerName, WarehouseSocketNumber);
            out = new PrintWriter(CustomerA.getOutputStream(), true);
            in = new BufferedReader(new InputStreamReader(CustomerA.getInputStream()));
